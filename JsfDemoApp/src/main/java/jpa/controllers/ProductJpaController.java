 ...
 */
@Service
public class ProductJpaController implements ProductJpaControllerService {
    /*
    @Resource
    ...
    public int getProductCount() {
        ...
        try {
            return ((Long) entityManager.createQuery("select count(o) from Product as o").getSingleResult()).intValue();
        } finally {
            //em.close();
        }
    }
